...
<html>
	...
	<body class="text-center" style="background-color: #f4f1de">
		<main class="form-signing w-100 m-auto">
			<form method="post" action="index">
				...
				<button class="w-100 btn btn-lg mt-3 btn-access" type="submit" style="background-color:#3d405b; color:#fff">Log in</button>
				<a href="registration.jsp" class="w-100 btn btn-lg mt-2 btn-registration" style="background-color: #e07a5f; color: #000; ">Sign up</a>
			</form>
		</main>
	</body>
</html>