	...
	<body class="text-center" style="background-color: #f4f1de">
		<main class="form-signing w-100 m-auto">
			<form method="post" action="registration">
				...
				<div class="form-floating">
					<input type="text" class="form-control mt-2" id="surname" placeholder="surname" name="surname">
				...
				<button class="w-100 btn btn-lg mt-2 btn-registration" type="submit" style="background-color: #e07a5f; color: #fff; ">Send data</button>
			</form>
		</main>
	</body>
</html>